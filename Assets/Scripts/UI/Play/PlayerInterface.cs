...
namespace Play
{
    public class PlayerInterface : UIBase
    {
        ...
        public void Set(string name, System.Action<string, string, PlayerInterface> onNameChanged, System.Action<string> onRemove)
        {
            ...
            this.nameInputButton.onClick.AddListener(delegate { InputScreen.Create().Set("What is the Name of this Player?", 3, 14, true, OnNameChanged, startValue: "", contentType: InputField.ContentType.Name, promptText: "Enter Name"); });
